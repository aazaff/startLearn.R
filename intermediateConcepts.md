...
rownames( ) |	Automatically names the second dimension (the rows) of an **array**. It requires an array with 2+ dimensions.
colnames( ) |	Automatically names the first dimesion (the columns) of an **array**. It requires an array with 2+ dimensions.
